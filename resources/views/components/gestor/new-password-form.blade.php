<div class="custom-card-100" id="new-password-group" style="margin: 15px 0;">
    <div class="row justify-content-center" style="text-align: center;" id="new-password-group-content">
        ...
        <div>
            <button id="b-save-code" class="custom-button-lt" style="width: 50%;min-width:150px;max-width:250px">Guardar</button>
        </div>
    </div>
</div>